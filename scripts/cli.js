...
const contractABI = require("../artifacts/contracts/GovernanceUi.sol/GovernanceUi.json").abi;

program
    .name("governance-ui-cli")
    .description("CLI tool for GovernanceUi smart contract")
    .version("1.0.0");
